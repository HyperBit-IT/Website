<template>
  <nav class="bg-white border-t border-gray-200 px-4 lg:px-6 py-2.5">
    <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
      ...
      <div class="flex items-center lg:order-2">
        <a class="text-gray-800 hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-4 focus:outline-none">
          <language-selector/>
        </a>
        <!--
      ...
      <div id="mobile-menu-2" :class="{hidden : !showMenu}"
           class=" justify-between items-center w-full lg:flex lg:w-auto lg:order-1">
        <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
          <li>
            <nuxt-link class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0"
                       href="/de-DE/"
                       @click="showMenu = !showMenu">Startseite
            </nuxt-link>
          </li>
          <li>
            <nuxt-link class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0"
                       href="/de-DE/contacts"
                       @click="showMenu = !showMenu">Kontakt
            </nuxt-link>
          </li>
          <li>
            <nuxt-link class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0"
                       href="/de-DE/privacy-policy"
                       @click="showMenu = !showMenu">Datenschutz
            </nuxt-link>
          </li>
        </ul>
      </div>
