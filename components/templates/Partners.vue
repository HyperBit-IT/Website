<template>
  <div class="bg-white py-24 sm:py-16">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <h2 class="text-center text-lg font-semibold leading-8 text-gray-900">{{ $t('partners') }}</h2>
      <div
          class="mx-auto mt-8 grid max-w-lg grid-cols-5 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-5 sm:gap-x-8 lg:mx-0 lg:max-w-none lg:grid-cols-5">
